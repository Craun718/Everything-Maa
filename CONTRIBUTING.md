...
5. Run `python -m pytest`, `python scripts/validate_skills.py`, `npm test`, and `npm pack --dry-run` before submitting a change. Changes to the create-maa-project integration must also pass `npm run smoke:create-project`.
